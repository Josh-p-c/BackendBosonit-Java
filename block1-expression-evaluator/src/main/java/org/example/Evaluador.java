...
public class Evaluador {
    public static void main(String[] args) {
        System.out.println("Crear un programa que reciba la ruta de un fichero\n" +
    ...
    public static void lecturayevaluacion() {
        try {
            ...
            File archivo = new File("evaluador.csv");
            System.out.println();
            ...
            while (reader.ready()) {
                ...
                if (partes[0].matches(regexpFecha)) {
                    formatoFecha(partes);}
                if (partes[0].matches(regexpEntero)) {
                    formatoNumero(partes);}
                if (partes[0].matches(regexpCadena)) {
                    formatoCadena(partes);}
            }
